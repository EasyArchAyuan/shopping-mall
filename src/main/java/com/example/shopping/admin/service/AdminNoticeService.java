...
public class AdminNoticeService {
        ...
        switch (type) {
            case 0:
                ...
                for (SysAdmin sysAdmin : adminList) {
                    ...
                    map.put("receive", String.valueOf(sysAdmin.getId()));
            ...
            case 1:
                ...
                for (SysMt sysMt : merchantList) {
                    long createTime = System.currentTimeMillis();
                    map.put("createTime", String.valueOf(createTime));
                    map.put("receive", String.valueOf(sysMt.getId()));
                    redisTemplate.opsForList().leftPush("notice", map);
                }
                break;
            case 2:
                ...
                for (SysUser sysUser : userList) {
                    long createTime = System.currentTimeMillis();
                    map.put("createTime", String.valueOf(createTime));
                    map.put("receive", String.valueOf(sysUser.getId()));
                    redisTemplate.opsForList().leftPush("notice", map);
                }
                break;
            default:
    ...
    public void addNotice(String title, String context, int type, int receive) {
