...
public class UserCheckOutService {
    ...
    public Map<Integer, Integer> getIdsMap(String ids) {
        ...
        for (String idsAndNumA : idsAndNumArray) {
            ...
            int id = Integer.parseInt(idsAndNum[0]);
            int num = Integer.parseInt(idsAndNum[1]);
            map.put(id, num);
        }
        return map;
    }
    ...
    public List<Integer> getCartIds(String ids) {
        ...
        for (String s : idsAndNumArray) {
            String[] idsAndNum = s.split(":");
            int cart = Integer.parseInt(idsAndNum[2]);
            list.add(cart);
        }
        return list;
    }
